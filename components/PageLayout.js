        ...
        <div className="sidebar">
          <div className="sidebar-content">
            ...
            <div className="nav-section">
              <Link href="/" className={'nav-item ' + (pathname === '/' ? 'active' : '')}><span className="nav-icon">&#x1F4CA;</span><span>Dashboard</span></Link>
            </div>
            {!isAllMode && (
              <div className="nav-section">
                <Link href="/claim-registration" className={'nav-item primary ' + (pathname === '/claim-registration' ? 'active' : '')}><span className="nav-icon">&#x1F4DD;</span><span>Claim Registration</span></Link>
              </div>
            )}
            <div className="nav-section">
              <Link href="/mis-portal" className={'nav-item ' + (pathname === '/mis-portal' ? 'active' : '')}><span className="nav-icon">&#x1F4C8;</span><span>MIS Portal</span></Link>
            </div>
            {!isAllMode && (
              <>
                <div className="nav-section">
                  <div className="nav-section-title">Masters</div>
                  <Link href="/insurer-master" className={'nav-item ' + (pathname === '/insurer-master' ? 'active' : '')}><span className="nav-icon">&#x1F3E2;</span><span>Insurer Master</span></Link>
                  <Link href="/policy-master" className={'nav-item ' + (pathname === '/policy-master' ? 'active' : '')}><span className="nav-icon">&#x1F4CB;</span><span>Policy Master</span></Link>
                  <Link href="/broker-master" className={'nav-item ' + (pathname === '/broker-master' ? 'active' : '')}><span className="nav-icon">&#x1F91D;</span><span>Broker Master</span></Link>
                  <Link href="/policy-directory" className={'nav-item ' + (pathname === '/policy-directory' ? 'active' : '')}><span className="nav-icon">&#x1F4C1;</span><span>Policy Directory</span></Link>
                  <Link href="/ref-number-portal" className={'nav-item ' + (pathname === '/ref-number-portal' ? 'active' : '')}><span className="nav-icon">&#x1F522;</span><span>Ref Number Portal</span></Link>
                </div>
                <div className="nav-section">
                  <div className="nav-section-title">Workflow</div>
                  <Link href="/workflow-overview" className={'nav-item ' + (pathname === '/workflow-overview' ? 'active' : '')}><span className="nav-icon">&#x1F504;</span><span>Workflow Overview</span></Link>
                </div>
                <div className="nav-section">
                  <div className="nav-section-title">Documents</div>
                  <Link href="/lor-ila-generator" className={'nav-item ' + (pathname === '/lor-ila-generator' ? 'active' : '')}><span className="nav-icon">&#x1F4C4;</span><span>LOR / ILA Generator</span></Link>
                  <Link href="/file-tracking" className={'nav-item ' + (pathname === '/file-tracking' ? 'active' : '')}><span className="nav-icon">&#x1F4C2;</span><span>File Tracking</span></Link>
                  <Link href="/file-assignments" className={'nav-item ' + (pathname === '/file-assignments' ? 'active' : '')}><span className="nav-icon">&#x1F4CE;</span><span>File Assignments</span></Link>
                </div>
                {user?.role === 'Admin' && (
                  <div className="nav-section">
                    <div className="nav-section-title">Admin</div>
                    <Link href="/user-management" className={'nav-item ' + (pathname === '/user-management' ? 'active' : '')}><span className="nav-icon">&#x1F465;</span><span>User Management</span></Link>
                    <Link href="/activity-log" className={'nav-item ' + (pathname === '/activity-log' ? 'active' : '')}><span className="nav-icon">&#x1F4CB;</span><span>Activity Log</span></Link>
                    <Link href="/user-monitoring" className={'nav-item ' + (pathname === '/user-monitoring' ? 'active' : '')}><span className="nav-icon">&#x1F441;</span><span>User Monitoring</span></Link>
                  </div>
                )}
                <div className="nav-section">
                  <div className="nav-section-title">Billing</div>
                  <Link href="/survey-fee-bill" className={'nav-item ' + (pathname === '/survey-fee-bill' ? 'active' : '')}><span className="nav-icon">&#x1F9FE;</span><span>Survey Fee Bill</span></Link>
                </div>
                <div className="nav-section">
                  <div className="nav-section-title">System</div>
                  <Link href="/backup" className={'nav-item ' + (pathname === '/backup' ? 'active' : '')}><span className="nav-icon">&#x1F4BE;</span><span>Data Backup</span></Link>
                </div>
                <div className="nav-section">
