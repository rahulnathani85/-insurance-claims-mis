...
//   lob_subcategory     — derived from lob; clerk picks
// ------------------------------------------------------------
export const REGISTRATION_AGENT_SCHEMA = [
  ...
  // Amounts
  { key: 'estimated_loss_amount',  type: 'amount', required: false, hint: 'Surveyor\'s preliminary loss estimate in integer rupees, if stated' },
  { key: 'gross_loss',             type: 'amount', required: false, hint: 'Insurer-stated gross loss in integer rupees, if mentioned' },
  { key: 'claim_amount_intimated', type: 'amount', required: false, hint: 'Claim amount on the intimation in integer rupees' },
];
