...
/**
 * Download FSR HTML as PDF — opens print dialog, user saves as PDF.
 * This is the most reliable method for complex layouts with tables,
 * page breaks, and branded styling.
 */
export async function downloadAsPDF(htmlContent, filename = 'document.pdf') {
  ...
  win.document.close();
  // Give the page time to render fully before printing
