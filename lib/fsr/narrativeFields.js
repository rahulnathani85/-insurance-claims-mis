...
export function labelForPlaceholder(path, lob) {
  ...
  for (const lobName of ['Marine Cargo', 'Marine Hull', 'Extended Warranty', 'Fire']) {
...
export const __FIELD_GROUPS__ = { MARINE_FIELDS, MARINE_HULL_FIELDS, EW_FIELDS, FIRE_FIELDS, ILA_EXTRAS };
