...
const FORM_FIELDS = [
  ...
  // 3-office insurer roles — populated by ThreeOfficePicker. Server hydrates
  // the *_name and *_address from the FK, but they round-trip through here
  // so the form can render the chip on reload.
